...
public class LimeLight extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if(tv.getDouble(0) == 1){
      ...
      distance.setDistance((LIME_LIGHT_CONSTANTS.GOAL_HEIGHT - LIME_LIGHT_CONSTANTS.LIME_HEIGHT)/(Math.tan(Math.toRadians(LIME_LIGHT_CONSTANTS.LIME_ANGLE + (tx.getDouble(0))))));
    }
    else{
    ...
    if(LIME_LIGHT_CONSTANTS.DEBUG || Constants.GLOBAL_DEBUG){
      ...
      SmartDashboard.putNumber("lime y", ty.getDouble(0));
